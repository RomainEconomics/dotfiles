...
vim.api.nvim_create_user_command('FloatTerminal', function() M.create_floating_window() end, {})

vim.api.nvim_create_user_command('FloatTerminalToggle', function() M.toggle() end, {})
